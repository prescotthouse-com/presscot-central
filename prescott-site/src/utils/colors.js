...
// Exported function that returns palette object with descriptive keys
// Each value switches between light and dark mode using ternaries

export const getPalette = (isDarkMode) => ({
    background: isDarkMode ? "#191918" : "#FCFCFA", // Main background color
    surface: isDarkMode ? "#282826" : "#F4F1EA",    // Surface / secondary background
